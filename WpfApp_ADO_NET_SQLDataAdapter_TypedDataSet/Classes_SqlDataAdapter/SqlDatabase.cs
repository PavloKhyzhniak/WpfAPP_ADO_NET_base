...
namespace WpfApp_ADO_NET_SQLDataAdapter_TypedDataSet.Classes_SqlDataAdapter
{
    public static partial class SqlDatabase
    {
        ...
        private static SqlConnection CreateSqlConnection_ConfigurationManager()
        {
            ...
            int portNumber = WpfApp_ADO_NET_SQLDataAdapter_TypedDataSet.Properties.Settings.Default.PortNumber;
            string userName = WpfApp_ADO_NET_SQLDataAdapter_TypedDataSet.Properties.Settings.Default.UserName;
