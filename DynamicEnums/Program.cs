...
namespace DynamicEnums
{
    class EnumCreator
    {
        ...
        static void Main1()
        {
            ...
            string connectionString = @"Data Source =.\SQLExpress; Initial Catalog = WpfApp_ADO_NET_CodeFirst.Model_ManufacturerAirplane; Integrated Security = True";
...
//                    "Source=ysg";
                    ...
                    new SqlConnection(connectionString))
            {
                ...
                command.CommandText = string.Format("SELECT [VendorId], " +
                        "[BrandTitle] FROM [dbo].[Manufacturers]");
